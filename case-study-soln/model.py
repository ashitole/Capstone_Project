...
MODEL_DIR = r"C:\Users\AshwiniShitole\Desktop\Ashwini\Personal\Data Science\AI Academy\AI Enterprise Workflow Certification\AI in Production\Capstone_Project\case-study-soln\models"
MODEL_VERSION = 0.1
...
def get_preprocessor():
    ...
    numeric_features = ['previous_7','previous_14','previous_28','previous_70','previous_year','recent_invoices','recent_views']
...
def model_load(prefix='sl',data_dir=None,training=True):
    ...
    models = [f for f in os.listdir(os.path.join(MODEL_DIR)) if re.search("sl",f)]
